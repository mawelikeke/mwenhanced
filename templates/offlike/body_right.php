...
<?php if(count($MW->getConfig->votebanner->enable) > 0): ?>
...
<?php echo $lang['si_status']; ?>:&nbsp;<?php if ($server['realm_status']): ?>
                <img src="<?php echo $offtmp; ?>/images/uparrow2.gif" height="15" alt="Online" /> <b style="color: rgb(35, 67, 3);">Online</b>
<?php else: ?>
                <img src="<?php echo $offtmp; ?>/images/downarrow2.gif" height="15" alt="Offline" /> <b style="color: rgb(102, 13, 2);">Offline</b>
<?php endif; ?>
</div></li>
