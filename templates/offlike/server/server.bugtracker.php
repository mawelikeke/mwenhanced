...
<?php if((int)$MW->getConfig->generic_values->forum->externalbugstracker) { ?>
<h3><a href="<?php echo (string)$MW->getConfig->generic_values->forum->bugstracker_external_link;?>"> --- Bugtracker forum --- </a></h3>
<?php }else{ ?>
