...
<?php foreach($item_res as $item): ?>
    <tr>
      ...
      src="<?php echo $offtmp ?>/images/icons/race/<?php echo $item['race'];?>-<?php echo $item['gender'];?>.gif" height="18" width="18" alt=""/></small></td>
      ...
      src="<?php echo $offtmp ?>/images/icons/class/<?php echo $item['class'];?>.gif" height="18" width="18" alt=""/></small></td>
