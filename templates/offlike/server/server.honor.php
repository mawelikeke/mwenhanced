...
<center>
<div class="blogbody" style="background-image:url('<?php echo $currtmp; ?>/images/light.jpg');">
<style media="screen" title="currentStyle" type="text/css">
#main { background: url('<?php echo $currtmp; ?>/images/forum-bg.jpg') repeat-y; }
...
<tbody><tr>
    <td colspan="3">
        <table background="<?php echo $currtmp; ?>/images/ss-border-top-bg.gif" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody><tr>
            <td align="left"><img src="<?php echo $currtmp; ?>/images/ss-border-top-left.gif" height="14" width="113"></td>
            <td align="right"><img src="<?php echo $currtmp; ?>/images/ss-border-top-right.gif" height="14" width="113"></td>
        </tr></tbody>
        </table>
    </td>
</tr>
<tr>
    <td background="<?php echo $currtmp; ?>/images/ss-border-left.gif"><img src="<?php echo $currtmp; ?>/images/pixel_002.gif" height="1" width="21"></td>
    <!-- Main Content --> 
    <td style="padding-left: 6px; padding-right: 6px;" bgcolor="#000000">
        <span class="lite">
        <p>
            <b><font color="#ffe400" size="3"><?php echo $lang['honor_ranking']; ?></font></b><br/>
                <?php echo $lang['honor_top']; ?> <?php echo $max_display_chars;?> <?php echo $lang['honor_fighters']; ?>
        </p>
        </p>
        </span>
        <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
        <tr><td align="center" width="50%" valign="top">
        <img src="<?php echo $currtmp; ?>/images/alliance2.png">
            <div>
                <table border="0" cellpadding="2" cellspacing="0" width="100%" align="center">
                <tr>
                    <td align="right" width="20"><b>#</b></td>
                    <td width="20"><?php echo $lang['rank']; ?></td>
                    <td width="20"><?php echo $lang['race']; ?></td>
                    <td width="20"><?php echo $lang['class']; ?></td>
                    <td><?php echo $lang['name']; ?></td>
                    <td align="center"><b><?php echo $lang['level_short']; ?></b></td>
                    <td align="center"><b><?php echo $lang['kills']; ?></b></td>
...
<?php } $pos = 0; ?>
        ...
        <img src="<?php echo $currtmp; ?>/images/horde2.png">
            <div>
                <table border="0" cellpadding="2" cellspacing="0" width="100%" align="center">
                <tr>
                    <td align="right" width="20"><b>#</b></td>
...
<?php } unset($item,$pos, $allhonor); ?>
    ...
    <td background="<?php echo $currtmp; ?>/images/ss-border-right.gif" width="10"><img src="<?php echo $currtmp; ?>/images/pixel_002.gif" height="1" width="21"></td>
</tr>
<tr>
    <td colspan="3">
        <table background="<?php echo $currtmp; ?>/images/ss-border-bot-bg.gif" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody><tr>
            <td valign="top"></td>
