...
<?php foreach($items as $item_c => $item){ ?>
    ...
    <dl class="topic_view" style="padding:1px;padding-left:5px;">
        ...
        <dd class="" style="font-size:11px;">
            <?php if($item['closed']==0){ ?><a title="<?php echo $lang['close'];?>" href="index.php?n=admin&sub=forum&action=close&forum_id=<?php echo $item['forum_id'];?>"><img src="<?php echo $currtmp; ?>/images/icons/normal_post.gif" align="absmiddle"></a><?php } ?>
            <?php if($item['closed']==1){ ?><a title="<?php echo $lang['open'];?>" href="index.php?n=admin&sub=forum&action=open&forum_id=<?php echo $item['forum_id'];?>"><img src="<?php echo $currtmp; ?>/images/icons/normal_post_locked.gif" align="absmiddle"></a><?php } ?>
            <?php if($item['hidden']==0){ ?><a title="<?php echo $lang['hide'];?>" href="index.php?n=admin&sub=forum&action=hide&forum_id=<?php echo $item['forum_id'];?>"><img src="<?php echo $currtmp; ?>/images/icons/normal_post_sticky.gif" align="absmiddle"></a><?php } ?>
            <?php if($item['hidden']==1){ ?><a title="<?php echo $lang['show'];?>" href="index.php?n=admin&sub=forum&action=show&forum_id=<?php echo $item['forum_id'];?>"><img src="<?php echo $currtmp; ?>/images/icons/my_normal_post.gif" align="absmiddle"></a><?php } ?>
            <a title="<?php echo $lang['recount'];?>" href="index.php?n=admin&sub=forum&action=recount&forum_id=<?php echo $item['forum_id'];?>"><img src="<?php echo $currtmp; ?>/images/icons/normal_poll.gif" align="absmiddle"></a>
