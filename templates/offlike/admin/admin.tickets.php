...
<?php foreach($ticket as $item): ?>
    <tr>
      ...
      <td class="serverStatus<?php echo $item['color'] ?>" align="center"><b style="color: rgb(35, 67, 3);"><center><?php echo $item['player_name']; ?></center></b></td>
...
<?php write_metalborder_header(); ?>
    ...
    <tr>
      <td class="rankingHeader" align="center" nowrap="nowrap">#</td>
	  <td class="rankingHeader" align="center" nowrap="nowrap">ID</td>
      <td class="rankingHeader" align="center" nowrap="nowrap">Character ID&nbsp;</td>
      <td class="rankingHeader" align="center" nowrap="nowrap">Message&nbsp;</td>
	  <td class="rankingHeader" align="center" nowrap="nowrap">Gm Comments&nbsp;</td>
    </tr>
<?php foreach($ticket as $item): ?>
    <tr>
      <td class="serverStatus<?php echo $item['color'] ?>" align="center"><b style="color: rgb(102, 13, 2);"><?php echo $item['id']; ?></b></td>
	  <td class="serverStatus<?php echo $item['color'] ?>" align="center"><b style="color: rgb(102, 13, 2);"><?php echo $item['ticket_id']; ?></b></td>
      <td class="serverStatus<?php echo $item['color'] ?>" align="center"><b style="color: rgb(35, 67, 3);"><center><?php echo $item['guid']; ?></center></b></td>
      <td class="serverStatus<?php echo $item['color'] ?>" align="center"><b style="color: rgb(102, 13, 2);"><?php echo $item['ticket_text']; ?></b></td>
	  <td class="serverStatus<?php echo $item['color'] ?>" align="center"><b style="color: rgb(102, 13, 2);"><?php echo $item['response_text']; ?></b></td>
    </tr>
<?php endforeach; unset($ticket, $item); ?>
    </tbody>
    </table>
