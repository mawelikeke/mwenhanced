...
<ul style="font-weight:bold;"><h2>Forum Manager</h2>
	...
	<li><a href="index.php?n=forum&sub=post&action=newtopic&f=<?php echo (int)$MW->getConfig->generic_values->forum->bugs_forum_id;?>">Add A Bug</a></li>
	<li><a href="index.php?n=forum&sub=viewforum&fid=<?php echo (int)$MW->getConfig->generic_values->forum->bugs_forum_id;?>">Manage <?php echo $lang['bugs'];?></a></li>
</ul>
<?php builddiv_end() ?>
