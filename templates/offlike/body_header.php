...
var forum_link = '<?php if($MW->getConfig->generic_values->forum->externalforum == 0) {
echo (string)$MW->getConfig->temp->base_href; echo "index.php?n=forum"; }else{ echo (string)$MW->getConfig->generic_values->forum->forum_external_link; } ?>';
var armory_link = '<?php echo $MW->getConfig->generic_values->armory->armory_path; ?>';</script>
