                                    ...
                                    <tr>
                                        ...
                                        <!-- //Begin Character Control Panel// -->
											...
											<div id="default-icon-panel">
												...
												<table cellspacing="0" cellpadding="0" border="0">
                                                        <tr>
                                                            <td style="background: url('<?php echo $dtmp."/images/icons/class/".$post['mini_class']; ?>'); width: 18px; height: 18px;">
															</td>
                                                        </tr>
                                                    </table>
												</div>
												...
												<table cellspacing="0" cellpadding="0" border="0">
                                                        <tr>
                                                            <td style="background: url('<?php echo $dtmp."/images/icons/faction/".$post['faction']; ?>'); width: 18px; height: 18px;">
															</td>
                                                        </tr>
                                                    </table>
												</div>
