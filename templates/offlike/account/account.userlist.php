...
<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%" class="bordercolor" style="font-size:0.8em;">
  <tbody>
    ...
    <tr style="text-align: center;">
      ...
      <td class="windowbg"><?php if($item['homepage'] && $item['homepage']!='http://'){ ?><a href="<?php echo $item['homepage']; ?>" target="_blank"><img src="<?php echo $currtmp; ?>/images/icons/www.gif" alt="WWW" border="0" /></a><?php } ?></td>
