...
<html>
	<head>
		<title><?php echo $site_name; ?> Terms of Service</title>
				...
				<td>
					<form action="GET">
						<table class="tabelbasic1" cellspacing="0" cellpadding="15" width="100%" style="font-size: 10pt">
							<tr>
								<td>
									<textarea name="S1" cols="80" rows="25" style="width: 100%; color: #ffac04; border: 1px #777777 solid;" readonly="readonly"><?php readfile('ToS.html'); ?></textarea>
								</td>
							</tr>
							<tr>
								<td align="center">
