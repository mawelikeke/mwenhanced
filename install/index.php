<?php
// =======================================
// MangosWeb V2 installer 1.0 by Wilson212
// =======================================
...
?>
<html><head><title>MangosWeb V2 Installer</title>
<?php
...
div.content {background: url('bg.jpg') repeat-y; width: 775px; position: relative; left: 50%; margin-left: -387px; height: 150%; }
...
if (!isset($_GET['s']) or $_GET['s'] == 1) {echo "MangosWeb V2 Installer: Step 1/3";} // Step 1
elseif ($_GET['s'] == 2) {echo "MangosWeb V2 Installer: Step 2/3";} // Step 2
elseif ($_GET['s'] == 3) {echo "MangosWeb V2 Installer: Step 3/3";} // Step 3
?>
</div>
</div>
...
if (!isset($_GET['s']) or $_GET['s'] == 1) { ?>
	<br />Welcome to the MangosWeb V2 installer!<br /><br />Please follow these few steps to set up your new site.<br /><br /><br /><br />
    <form action="index.php?s=2" method="post">
	<b>Emulator details:</b><br /><br />
	<table>
		<tr>
			<td> Emulator: </td>
			<td><select name="emu"><option value="mangos">Mangos</option><option value="trinity">Trinity</option></select></td>
		<tr>
	</table>
	<br />
    ...
    <table>
        ...
        <tr>
            <td>World db:</td><td><input type='text' name='world_db_name' value='<?php echo "world"; ?>'></td>
        </tr>
        <tr>
...
else {echo "Warning!<br /><br />The installer has detected that you already have an installed version of TrinityWeb in your database.";
      echo " You can either proceed, but note that in this case old tables will be dropped and all of your current TrinityWeb database data will be irrecoverably lost.";
