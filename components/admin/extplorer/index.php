 ...
 */
 // If the installer file exists, we need to kill the program for saftey purposes :p
 if (file_exists("config/disable_installer.php")) die("For security reasons, this function is disabled. To enable this feature, delete the file \"(mangosweb root)\" /components/admin/extplorer/config/disable_installer.php
 <br /><br />Once enabled, first time login info; Username: admin Password: admin. REMEMBER TO CHANGE YOUR PASSWORD!");
