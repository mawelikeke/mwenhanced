    ...
    elseif($_GET['action']=='createchar'){
        ...
        ####################### INSERT TO Database ########################
          ...
          if (strstr($COPY_BAG_SUB_item_instance['data'], $COPY_WORK_item_instance['old_guid']) == TRUE){
            ...
            '".$COPY_character['position_y']."', '".$COPY_character['position_z']."', '".$COPY_character['map']."', '".$COPY_character['instance_id']."', '".$COPY_character['dungeon_difficulty']."', '".$COPY_character['orientation']."', '".$COPY_character['taximask']."', '".$COPY_character['online']."',
            ...
            '".$COPY_character['trans_z']."', '".$COPY_character['trans_o']."', '".$COPY_character['transguid']."', '".$COPY_character['extra_flags']."', '".$COPY_character['stable_slots']."', '".$COPY_character['at_login']."', '".$COPY_character['zone']."', '".$COPY_character['death_expire_time']."', 
			'".$COPY_character['taxi_path']."', '".$COPY_character['arenaPoints']."', '".$COPY_character['totalHonorPoints']."', '".$COPY_character['todayHonorPoints']."', '".$COPY_character['yesterdayHonorPoints']."', '".$COPY_character['totalKills']."', '".$COPY_character['todayKills']."', 
			'".$COPY_character['yesterdayKills']."', '".$COPY_character['chosenTitle']."', '".$COPY_character['knownCurrenies']."', '".$COPY_character['watchedFaction']."', '".$COPY_character['drunk']."', '".$COPY_character['health']."', '".$COPY_character['power1']."', '".$COPY_character['power2']."', 
			'".$COPY_character['power3']."', '".$COPY_character['power4']."', '".$COPY_character['power5']."', '".$COPY_character['power6']."', '".$COPY_character['power7']."', '".$COPY_character['speccount']."', '".$COPY_character['activespec']."', '".$COPY_character['exploredZones']."', 
			'".$COPY_character['equipmentCache']."', '".$COPY_character['ammoId']."', '".$COPY_character['knownTitles']."', '".$COPY_character['actionBars']."', '".$COPY_character['latency']."')");
