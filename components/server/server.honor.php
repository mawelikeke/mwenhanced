...
function zerohonorfilter($var){
    ...
    foreach($charinfo_arr as $charinfo_item){
        ...
        $character = array(
            ...
            'race_icon'   => $offtmp .'/images/icons/race/'.$charinfo_item['race'].'-'.$charinfo_item['gender'].'.gif',
            'class_icon'   => $offtmp .'/images/icons/class/'.$charinfo_item['class'].'.gif',
            'rank_icon'   => $offtmp .'/images/icons/pvpranks/rank'.$char_rank_id.'.gif',
        );
