...
//===== Calc pages =====//
$items_per_pages = (int)$MW->getConfig->generic_values->forum->topics_per_page;
...
foreach($alltopics as $cur_topic)
{
    ...
    $pnum = ceil($cur_topic['num_replies']/(int)$MW->getConfig->generic_values->forum->posts_per_page);
    if($pnum>1){
