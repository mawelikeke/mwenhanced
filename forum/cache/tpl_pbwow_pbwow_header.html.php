			...
			<tr>
				<td>
					...
					<div id="forumHead" style="position:relative">
						<div class="icon"><a href="<?php echo (isset($this->_rootref['U_VIEW_FORUM'])) ? $this->_rootref['U_VIEW_FORUM'] : ''; ?>"><?php if ($this->_rootref['PBFORUM_IMAGE_SRC']) {  ?><img src="<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/forumbullets/bc/<?php echo (isset($this->_rootref['PBFORUM_IMAGE_SRC'])) ? $this->_rootref['PBFORUM_IMAGE_SRC'] : ''; ?>" width="85" height="89" border="0" /><?php } else { ?><img src="<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/forumbullets/bc/blizzard.gif" width="85" height="89" border="0" /><?php } ?></a></div>
						<div class="list">
							<ul>
								<li class="title">
					...
					<div id="user">
						...
						<div class="body">
							<ul>
								...
								<li><span title="<?php echo ((isset($this->_rootref['L_SEARCH_SELF'])) ? $this->_rootref['L_SEARCH_SELF'] : ((isset($user->lang['SEARCH_SELF'])) ? $user->lang['SEARCH_SELF'] : '{ SEARCH_SELF }')); ?>"><b><?php if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?><a href="<?php echo (isset($this->_rootref['U_SEARCH_SELF'])) ? $this->_rootref['U_SEARCH_SELF'] : ''; ?>"><?php echo (isset($this->_rootref['S_USERNAME'])) ? $this->_rootref['S_USERNAME'] : ''; ?></a><?php } else { echo (isset($this->_rootref['S_USERNAME'])) ? $this->_rootref['S_USERNAME'] : ''; } ?></b></span></li>
								<br/>
